...
modelsummary(
  ...
  stars = c('+' = 0.1, '*' = 0.05),
  coef_rename = c(
    'chngfriends_endTRUE' = 'Change in Friends', 'chngorgs_endTRUE' = 'Change in Org. Memberships',
    'chngeduc_endTRUE' = 'Change in Educ. Standing', 'chngmarital_endTRUE' = 'Change in Marital Status',
    'chngchildre_endTRUE' = 'Change in Children', 'chngwrkstat_endTRUE' = 'Change in Work Status',
...
modelsummary(
  ...
  stars = c('+' = 0.1, '*' = 0.05),
  coef_rename = c(
    'numcult_mean' = 'Cultural Breadth (Between)', 'educ_mean' = 'Education (Between)',
    'married_mean' = 'Married (Between)', 'childre_mean' = 'Children (Between)',
    'bigcity_mean' = 'Big City (Between)', 'numcult_within' = 'Cultural Breadth (Within)',
    'educ_within' = 'Education (Within)', 'married_within' = 'Married (Within)',
    'childre_within' = 'Children (Within)', 'bigcity_within' = 'Big City (Within)',
