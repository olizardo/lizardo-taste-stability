use "N:\Private\NETWORKS AND CULTURE\taste-change\pc1985-90.dta" 

*/creating cultural taste scales
forval i=3/4 {
	for var  music`i' movie`i' sports`i' paper`i' books`i' spevent`i'  hobby`i' tv`i'  friends`i':recode X 0=. 8/9=.
	}
...
lab var chorgs "Organizational Memberships"
