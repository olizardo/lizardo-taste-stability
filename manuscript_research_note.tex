...
\begin{abstract}
Does cultural taste primarily flow from shifting social networks, or do durable cultural tastes help stabilize personal communities over time? Network transmission models posit that tastes are volatile and decay when social ties are disrupted, whereas cultural capital models posit that tastes are enduring dispositions that facilitate tie maintenance. Using longitudinal panel data from the Project Canada Survey (1985--1995), I adjudicate between these frameworks via descriptive event-history tracking and Mundlak Poisson models. I find that cultural tastes exhibit remarkably high levels of over-time stability (roughly 98\% retention over five years), countering standard network volatility assumptions. The extreme rarity of taste loss undermines the network-theoretic expectation that structural network turnover frequently drives cultural shedding, though network shocks do predict the \emph{acquisition} of new tastes, revealing an additive asymmetry. Furthermore, holding durable cultural breadth (omnivore tastes) longitudinally predicts higher rates of maintained social connectivity, specifically for ``chosen'' ties (friends) rather than structurally ``obligated'' ties (family). These findings point toward a decisive advantage for the cultural capital model: tastes act as durable, selective filters that maintain voluntary social ties, while remaining highly resilient to network shocks.
\end{abstract}
...
(3) Does a broad, stable repertoire of cultural tastes (cultural capital) longitudinally predict the maintenance of social connectivity, independent of reciprocal effects? (4) Is the dynamic of cultural tastes asymmetric, such that network turnover drives the acquisition of new tastes but not the loss of old ones? (5) Does cultural capital specifically buffer ``chosen'' ties (friends) rather than structurally obligated ties (family and kin)?
...
\emph{Cultural taste acquisition indicators}. To test the asymmetry of taste dynamics, I also construct inverse event-history indicators for taste acquisition. Here, the risk set is restricted to respondents who engaged in an activity ``seldom'' or ``never'' at the start of a period ($t$). The dependent variable equals 1 if they acquired the taste (participation increased to ``very often'' or ``sometimes'') by the end of the period ($t+1$), and 0 otherwise.
...
For the frequency of interaction with friends, the survey asked respondents to indicate their level of interaction on an ordinal scale, with response categories originally coded such that 1 equaled ``Many'' (or high frequency) and 3 equaled ``Few'' (or low frequency) in earlier waves. This variable was programmatically harmonized and inverted prior to estimation so that higher integer values correctly reflect greater social connectivity. While originally ordinal, it is treated here as a count-like indicator of informal sociability in the Mundlak Poisson models for consistency with the formal membership count. In addition to friends, I incorporate a measure of formal kin interaction: the frequency of interaction with family members. This was surveyed on a similar ordinal scale, programmatically inverted so higher scores reflect greater interaction, and standardized (z-scored) within each wave. The friendship interaction variable is similarly standardized in these specific comparative models to allow for direct coefficient comparison between kin and non-kin ties.
...
This supports the cultural capital assumption that tastes are highly stable over time, exhibiting stability rates that far exceed what is typically observed for personal networks \citep{suitor1997, wellman1997}. Because the absolute rate of taste shedding is close to zero, it is mathematically impossible for network turnover (which occurs frequently) to be systematically driving mass abandonment of cultural practices. The network hypothesis of taste volatility is thus poorly supported by these data; tastes behave as durable dispositions rather than malleable contents subject to relational disruptions.

However, while tastes are rarely lost, they are frequently gained. Examining the \emph{acquisition} of new tastes reveals a stark asymmetry: over a five-year period, massive proportions of non-participants acquired a taste for music (56\%), books (45\%), and sports (29\%). Furthermore, pooled discrete-time logistic regressions predicting taste acquisition (see Appendix) demonstrate that network turnover events---such as geographic mobility, changes in work status, and changes in organizational memberships---significantly predict the uptake of these new cultural practices. This supports an additive model of cultural capital: life-course shocks expose individuals to new network spheres that transmit new tastes, but owing to the embodied durability of the habitus, individuals do not shed their old tastes when previous networks fracture.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{tex/taste_asymmetry.png}
\caption{The Asymmetry of Taste Dynamics. Taste acquisition is common and driven by network turnover, while taste loss is exceptionally rare.}
\label{fig:taste_asymmetry}
\end{figure}
...
\emph{Tie-Specific Buffering: Kin vs. Non-Kin.} The culture conversion hypothesis posits that cultural capital provides conversational resources to maintain relationships. However, sociological theory differentiates between ``chosen'' ties (friends) maintained by homophily, and structurally ``obligated'' ties (family) maintained by duty. To test this, I compare the effect of cultural breadth on standardized interaction frequencies for friends versus family using the Mundlak framework.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{tex/kin_vs_nonkin.png}
\caption{Cultural Capital Maintains Chosen Ties Over Obligated Ties.}
\label{fig:kin_vs_nonkin}
\end{figure}

Consistent with expectations, the effect of average cultural breadth on friendship interaction ($t = 7.24$) is more than double its effect on family interaction ($t = 2.62$). Cultural capital is a tool specifically used to generate and maintain weak or chosen ties in modern societies; it matters much less for maintaining family relationships, which operate on a logic of structural obligation rather than shared cultural homophily (see Appendix for full models).
...
\input{tex/pcs_taste_acquisition.tex}
\input{tex/pcs_kin_comparison.tex}
