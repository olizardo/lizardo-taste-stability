...
(1) Does a broad, stable repertoire of cultural tastes (cultural capital) longitudinally predict the maintenance of social connectivity, independent of reciprocal effects? (2) Does cultural capital specifically buffer ``chosen'' ties (friends) rather than structurally prescribed ties (family and kin)? (3) Do temporary, within-person spikes in cultural engagement yield immediate gains in connectivity?
...
The models include the following sociodemographic controls: gender, age, education, city size, employment status, marital status, and presence of children in the household. The descriptive statistics of the variables are detailed in the Appendix (Table \ref{tab:descriptives}).
...
\caption{Cultural Capital Maintains Chosen Ties Over prescribed Ties.}
\label{fig:kin_vs_nonkin}
\end{figure}

\subsection{Tie-Specific Buffering: Kin vs. Non-Kin} As shown in Figure \ref{fig:kin_vs_nonkin}, the culture conversion hypothesis posits that cultural capital provides conversational resources to maintain relationships. However, sociological theory differentiates between ``chosen'' ties (friends) maintained by homophily, and structurally ``prescribed'' ties (family) maintained by duty. To test this, I compare the effect of cultural breadth on interaction frequencies for friends versus family using parallel Mundlak cumulative link models (Table \ref{tab:kin_comparison}).
